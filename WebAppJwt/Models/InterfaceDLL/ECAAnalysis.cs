...
namespace River_X.Models.InterfaceDLL
{
    public static class ECAAnalysis
    {
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "MainEntry", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "Kmat_Calc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Kmat_Calc(ref double CVN, ref double B, ref double Kmat);


        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "Lrmax_calc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Lrmax_calc(ref double UTS, ref double YS, ref double Lrmax);


        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "strainLuder", CallingConvention = CallingConvention.Cdecl)]
        public static extern void strainLuder(ref double YS, ref double eps_Luder_end, ref int isCalcOk, [In, Out]char[] Message);


        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "getStrainVector", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "ConstructStressStrainCurve", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "Kr_Luder_Calc", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Kr_Luder_Calc(ref double E, ref double YS, ref double eps_Luder_end, ref double Kr_Luder);


        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "Kr_calc", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "Lr_calc", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "failureAssessDiag", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "SIF_externalSurfaceBreaking", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "SIF_internalSurfaceBreaking", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "SIF_Embedded", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "sigma_ref_surfaceBreaking", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "sigma_ref_embedded", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\ECA_DLL.dll", EntryPoint = "check_Lr_Kr", CallingConvention = CallingConvention.Cdecl)]
