...
namespace River_X.Models.InterfaceDLL
{
    ...
    {
        [DllImport("River_X_DLL.dll", EntryPoint = "impactPipeOnRiverBed", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "impactPipeOnRiverBedFromF107", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "analyticalStaticAnalysis_qPLoad", CallingConvention = CallingConvention.Cdecl)]
    ...
    ref double a, ref double b, ref double Tnl, ref double Teff, ref double ymax, ref double yb, ref double Mm, ref double Mb, ref double ymaxP, ref double MbP, ref double MmP, ref double ybP,
     ref double ymaxq, ref double ybq, ref double Mmq, ref double Mbq, ref int isCalcOK);
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "writeAnalyticalEmbk_qPLoad", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "writeAnalyticalExpose_qPLoad", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "maxImpactScheme1", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "PmaxEstimateFromSxx", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "PmaxEstimateFromSvon", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "MaxImpactFromStrainEnergy", CallingConvention = CallingConvention.Cdecl)]
