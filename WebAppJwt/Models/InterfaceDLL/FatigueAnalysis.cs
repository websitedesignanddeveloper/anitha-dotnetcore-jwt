...
namespace WebAppJwt.Models.InterfaceDLL
{
    public static class FatigueAnalysis
    {
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "C4andC5", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C4andC5(ref double Lspan, ref double Leff, ref double C4, ref double C5);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "concreteStiffeningFactor", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "betaCoeff", CallingConvention = CallingConvention.Cdecl)]
        public static extern void betaCoeff(ref double dynK, ref double Lspan, ref double CSF, ref double KBendPipe, ref double beta);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "Leffective", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Leffective(ref double Lspan, ref double beta, ref double L);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "eulerLoad", CallingConvention = CallingConvention.Cdecl)]
        public static extern void eulerLoad(ref double CSF, ref double Leff, ref double KBendPipe, ref double PE);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "dampingEffect", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "deflecF105", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "naturalFreq", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "reducedVelocity", CallingConvention = CallingConvention.Cdecl)]
        public static extern void reducedVelocity(ref double gamaf, ref double Uc, ref double ODtotal, ref double fn, ref double VR);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "onsetVeloIL", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "constructInLineResponse", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "psiAlfaCurrIL", CallingConvention = CallingConvention.Cdecl)]
        public static extern void psiAlfaCurrIL(ref double alfaC, ref double psiAlfaC);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "psiProximity", CallingConvention = CallingConvention.Cdecl)]
        public static extern void psiProximity(ref double Lspan, ref double Leff, ref double C4, ref double C5);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "psiMass", CallingConvention = CallingConvention.Cdecl)]
        public static extern void psiMass(ref double SG, ref double psiM);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "psiAlfaCurrCF", CallingConvention = CallingConvention.Cdecl)]
        public static extern void psiAlfaCurrCF(ref double alfaC, ref double psiAlfaC);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "psiTrench", CallingConvention = CallingConvention.Cdecl)]
        public static extern void psiTrench(ref double dtrench, ref double egap, ref double ODtotal, ref double psiTren);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "onsetVeloCF", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "constructCrossFlowResponse", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "unitStressAmp", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "vivStressRange", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "returnCyclesToFailure", CallingConvention = CallingConvention.Cdecl)]
        public static extern void returnCyclesToFailure(ref double log10C, ref double m, ref double S, ref double N);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "returnFatLife", CallingConvention = CallingConvention.Cdecl)]
