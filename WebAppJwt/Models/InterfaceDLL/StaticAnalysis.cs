...
namespace River_X.Models.InterfaceDLL
{
    public static class StaticAnalysis
    {
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "analyticalStaticAnalysis", CallingConvention = CallingConvention.Cdecl)]
    ...
    ref double a, ref double b, ref double Tnl, ref double Teff, ref double ymax, ref double yb, ref double Mm, ref double Mb, ref int isCalcOK);
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "mainStaticAnalysis", CallingConvention = CallingConvention.Cdecl)]
    ...
    ref double a, ref double b, ref double Tnl, ref double Teff, ref double ymax, ref double yb, ref double Mm, ref double Mb, ref int isCalcOK);
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "writeAnalyticalEmbk", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "writeAnalyticalExpose", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "returnStresses", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "vonMisesStress2D", CallingConvention = CallingConvention.Cdecl)]
        public static extern void vonMisesStress2D(ref double St, ref double Sb, ref double Sy, ref double Txy, ref double Svm);


        [DllImport("Fortran_DLLs\\River_X_DLL.dll", EntryPoint = "principalStress2D", CallingConvention = CallingConvention.Cdecl)]
