...
namespace River_X.Models.InterfaceDLL
{
    public static class IntermediateCalcs
    {
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "mainIntermediateCalcs", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "diameterCalc", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "pipeStiffness", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "massCalc", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "addedMass", CallingConvention = CallingConvention.Cdecl)]
        public static extern void addedMass(ref double eonD, ref double rhoWater, ref double ODtotal, ref double ma);


        [DllImport("River_X_DLL.dll", EntryPoint = "initAxialTension", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "flowVelocities", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "velocityProfile", CallingConvention = CallingConvention.Cdecl)]
        public static extern void velocityProfile(ref double Ustar, ref double z, ref double z0, ref double Uz);


        [DllImport("River_X_DLL.dll", EntryPoint = "hydroForces", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "returnDragCoef", CallingConvention = CallingConvention.Cdecl)]
        public static extern void returnDragCoef(ref double CD, ref double CL);


        [DllImport("River_X_DLL.dll", EntryPoint = "Chezy2Manning", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Chezy2Manning(ref double Chezy, ref double Islope, ref double q, ref double Manning);


        [DllImport("River_X_DLL.dll", EntryPoint = "Manning2Chezy", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Manning2Chezy(ref double Manning, ref double Islope, ref double q, ref double Chezy);


        [DllImport("River_X_DLL.dll", EntryPoint = "lateralSoilResist", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "returnAxialMu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void returnAxialMu(ref double phiFric, ref double fPhi, ref double muAx);


        [DllImport("River_X_DLL.dll", EntryPoint = "axialSoilResistFromPRCI", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "setSoilStiffnessFromF105", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "returnSandModulusFromPRCI", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "returnClayModulusFromPRCI", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "setSoilStiffnessFromPRCI", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("River_X_DLL.dll", EntryPoint = "returnLoadonPipe", CallingConvention = CallingConvention.Cdecl)]
